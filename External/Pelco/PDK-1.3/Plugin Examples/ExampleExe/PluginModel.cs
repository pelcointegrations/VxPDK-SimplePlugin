...
namespace ExampleExePlugin
{
    class PluginModel : INotifyPropertyChanged
    {
        #region ConstructorAndVariables
        private PluginLog _pluginLog = new PluginLog("TraceExampleExePlugin");
        ...
        {
            // Log the event to TraceExampleExePlugin.txt file next to the .exe file IF the appropriate .config settings are set.
